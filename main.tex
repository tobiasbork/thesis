...
\usepackage[backend=biber,style=numeric,citestyle=alphabetic,natbib=true]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
