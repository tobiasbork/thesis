...
\begin{split}
\argmax_{\mat P} = \spur{\mat K_{xx}\mat P}\\
...
In (\ref{semidefinite_programming}) wird allerdings $\mat P$ berechnet und nicht die eigentliche Hauptachse. Hierfür kürzen d'Aspremont et al. die Matrix $\mat P$ und behalten nur den größten Eigenvektor $v_k$. Anschließend erhält man weitere Hauptachsen durch Matrix Deflation, indem wir $\mat K_{xx}$ durch
$$\mat K_{xx} - (v_k^{\top}\mat K_{xx}v_k) v_kv_k^{\top}$$ 
