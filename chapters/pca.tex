...
Ein sehr ähnliches Resultat hält auch für ein sog. \textit{spiked covariance model}, in welcher mehrere Komponenten betrachtet werden \cite{paul}. Des Weiteren zeigen Jung und Marron eine starke Inkonsistenz der Stichprobenhauptachsen in einer HDLSS-Situation unter geeigneten Modellannahmen. Dabei kann Konsistenz nur dann gewährleistet werden, wenn die führenden Eigenwerte klar größer sind als die Restlichen und weitere Eigenschaften gewährleistet sind. Für Details verweisen wir auf \cite{jung}.
