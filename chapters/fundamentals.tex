...
\centering
	...
	\end{subfigure}
\caption{Die Abbildung zeigt die beiden Operationen soft-thresholding $\operatorname{soft}_{\delta}(x)$ (links) und hard-thresholding $\operatorname{hard}_{\delta}(x)$ (rechts).}
