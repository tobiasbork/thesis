...
Auch wenn klassische Kriterien für die Konvergenz von Koordinatenabstiegsverfahren aufgrund der Differenzierbarkeit, welche nicht hier nicht gegeben ist, nicht zutreffen, besitzt (\ref{elastic_net_python}) eine Eigenschaft, für welche das Verfahren konvergiert \cite{tseng}. Bezüglich der Laufzeit .
